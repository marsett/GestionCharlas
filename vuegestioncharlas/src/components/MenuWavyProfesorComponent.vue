<template>
  <div class="nav">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <!-- Links centrados -->
      <ul v-if="!isMobile" class="nav nav-custom justify-content-center m-0">
        <li
          class="nav-item"
      ...
      <div class="profile-container dropdown">
        ...
        >
          ...
          <li
            v-for="(item, index) in isMobile ? mobileNavItems : []"
            :key="`dropdown-${index}`"
          >
            <a
              class="dropdown-item"
...
export default {
  name: "MenuWavyProfesorComponent",
  data() {
    return {
      nombre: "",
  ...
  mounted() {
    ...
    // Agregar un listener para el redimensionamiento
